...
) : SaveChangesInterceptor
{
    ...
    public void UpdateEntities(DbContext? context)
    {
        ...
        {
            if(entry.State is EntityState.Added or EntityState.Modified || entry.OwnedEntityChanged())
            {
...
{
    public static bool OwnedEntityChanged(this EntityEntry entry) =>  
        entry.References.Any(re => 
            re.TargetEntry?.Metadata.IsOwned() == true &&
